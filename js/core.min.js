            ...
            g(this).on("bind", "tabactivate", function(t, e) {
                ...
                s.find(".resp-tab-item").each(function() {
                    ...
                    s.find(".resp-tab-content." + l.tabidentify).each(function() {
                        g(this).attr("aria-labelledby", l.tabidentify + "_tab_item-" + t).css({
                            "border-color": l.active_border_color
                        }), t++
                    }), e++
                });
...
function(g, o, t, f) {
    ...
    c.prototype = {
        ...
        _findParticles: function() {
            ...
            if (this.particles !== f)
                for (var t = this.particles.length - 1; 0 <= t; t--) this.particles[t].$element.data("stellar-elementIsActive", f);
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, s, o, n, r, a, l = g(this),
                    c = 0,
                    d = 0,
                    h = 0,
                    u = 0;
        ...
        _repositionElements: function() {
            var t, e, i, s, o, n, r, a, l, c, d = this._getScrollLeft(),
...
function(t) {
    ...
    t.prototype = {
        ...
        _close: function() {
            u(l);
            var t = i + " " + x + " ";
            g.bgOverlay.detach(), g.wrap.detach(), g.container.empty(), g.st.mainClass && (t += g.st.mainClass + " "), g._removeClassFromMFP(t), g.fixedContentPos && (t = {
                marginRight: ""
            }, g.isIE7 ? c("body, html").css("overflow", "") : t.overflow = "", c("html").css(t)), f.off("keyup.mfp focusin" + w), g.ev.off(w), g.wrap.attr("class", "mfp-wrap").removeAttr("style"), g.bgOverlay.attr("class", "mfp-bg"), g.container.attr("class", "mfp-container"), !g.st.showCloseBtn || g.st.closeBtnInside && !0 !== g.currTemplate[g.currItem.type] || g.currTemplate.closeBtn && g.currTemplate.closeBtn.detach(), g.st.autoFocusLast && g._lastFocusedEl && c(g._lastFocusedEl).focus(), g.currItem = null, g.content = null, g.currTemplate = null, g.prevHeight = 0, u("AfterClose")
        },
        ...
        n();
        var e, i, s, o = c(this);
        return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = o, e.delegate && (s = s.find(e.delegate)), s.eq(i)), g._openClick({
            mfpEl: s
        }, o, e)) : g.isOpen && g[t].apply(g, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), a ? o.data("magnificPopup", t) : o[0].magnificPopup = t, g.addGroup(o, t)), o
    };
